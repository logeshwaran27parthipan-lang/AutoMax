          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-3">
              <span className="inline-flex items-center gap-1.5 px-4 py-1.5 text-sm font-medium text-[#1A1A2E] bg-[#FEF3C7] rounded-full mb-6">
                <span className="text-[#F59E0B]">✦</span> Built for Indian
                businesses
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold text-[#1A1A2E] leading-[1.15] mb-6">
                Stop doing the same
                <br />
                work twice.
              </h1>
              <p className="text-lg text-[#6B7280] leading-relaxed mb-8 max-w-xl">
                AutoMax connects your WhatsApp, Email, and Google Sheets — and
                runs your business workflows automatically.
              </p>
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1A1A2E] mb-4">
      ...
      <section id="how-it-works" className="bg-[#F3F4F6] py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1A1A2E]">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="text-center relative">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                Link your WhatsApp, Gmail, and Google Sheets in minutes. No
                coding needed.
              </p>
            </div>
            <div className="text-center relative">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                Choose a trigger and add steps. AutoMax gives you pre-built
            ...
            <div className="text-center relative">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                Your workflow runs automatically — 24/7, even when you&apos;re
                sleeping.
              </p>
            </div>
          </div>
      ...
      <section id="pricing" className="bg-[#F3F4F6] py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#6B7280]">
              AutoMax believes every small business deserves automation — not
              just the big ones.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="p-8 bg-white border-2 border-[#F59E0B] rounded-xl relative">
              ...
              <button className="block w-full py-3 text-center text-base font-semibold text-[#1A1A2E] border-2 border-[#1A1A2E] hover:bg-[#1A1A2E] hover:text-white rounded-lg transition-colors">
                Join Waitlist
              </button>
            </div>
          </div>
      ...
      <section className="bg-[#1A1A2E] py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Join hundreds of Indian businesses saving hours every week with
            AutoMax.
          </p>
          <Link
            href="/register"
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="text-sm text-[#6B7280] mt-4">
                Made with care in Chennai, Tamil Nadu, India 🇮🇳
              </p>
            </div>
